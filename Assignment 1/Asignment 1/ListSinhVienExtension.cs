    ...
    public static class ListSinhVienExtension {
        ...
        private static string readPhone(string msg)
        {
            ...
            do
            {
                ...
                c = new Regex(@"^\d{6,10}$").IsMatch(phone);
                if (!c)
                {
                    Console.WriteLine("So dien thoai co 6 - 10 chu so");
                }
            } while (!c);
            return phone;
        }
        ...
        public static void ThemSinhVien(this List<SinhVien> list) {
            ...
            string dienThoai = readPhone("So dien thoai: ");
        ...
        public static void ChinhSuaSinhVien(this List<SinhVien> list) {
            ...
            if (sv == null)
            {
                ...
                sv.DienThoai = readPhone("So dien thoai: ");
